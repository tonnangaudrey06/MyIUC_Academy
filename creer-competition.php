...
<div class="block">
    <form class="form-horizontal form-bordered ui-formwizard" name="protournoi_competitionbundle_competition" method="post" action="./api/newcompetition.php">
        <div class="step ui-formwizard-content">
            ...
            <fieldset>
                ...
                <div class="form-group "><label class="col-md-4 control-label required" for="protournoi_competitionbundle_competition_name">Nom de ma compétition
                        *</label>
                    <div class="col-md-5"><input type="text" id="protournoi_competitionbundle_competition_name" name="name" required="required" maxlength="255" class="form-control" /></div>
                </div>
                <div class="form-group "><label class="col-md-4 control-label" for="protournoi_competitionbundle_competition_sport">Sport *</label>
                    <div class="col-md-5"><select id="protournoi_competitionbundle_competition_sport" name="sport" class="select-select2" style="width:100%" class="form-control">
                ...
                <div class="form-group "><label class="col-md-4 control-label" for="protournoi_competitionbundle_competition_location">Lieu de ma
                        compétition</label>
                    <div class="col-md-5"><input type="text" id="protournoi_competitionbundle_competition_location" name="location" maxlength="255" class="form-control" /></div>
                </div>
                <div class="form-group "><label class="col-md-4 control-label" for="protournoi_competitionbundle_competition_description">Détails à propos
                    ...
                    <div class="col-md-5"><textarea id="protournoi_competitionbundle_competition_description" name="description" class="ckeditor" style="width:100%" class="form-control"></textarea>
                    </div>
                </div>
            </fieldset>
            <fieldset>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-md-5">
                        <div class="input-group input-daterange" data-date-format="dd/mm/yyyy">
                            <input type="text" id="protournoi_competitionbundle_competition_beginDate" name="beginDate" required="required" placeholder="Début" readonly="readonly" class="form-control readonly-date" class="form-control" />
                            <span class="input-group-addon"><i class="fa fa-angle-right"></i></span>
                            <input type="text" id="protournoi_competitionbundle_competition_endDate" name="endDate" required="required" placeholder="Fin" readonly="readonly" class="form-control readonly-date" class="form-control" />
                        </div>
                    </div>
                </div>
                <div class="form-group ">
                    ...
                    <div class="col-md-5">
                        <div class="row">
                            ...
                            <div id="registrationDeadlineField" class="col-sm-10" style="visibility:hidden">
                                <input type="text" id="protournoi_competitionbundle_competition_registrationDeadline" name="registrationDeadline" class="input-datepicker form-control readonly-date" data-date-format="dd/mm/yyyy" placeholder="Entrez la date limite d&#039;inscription" readonly="readonly" class="form-control" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <fieldset>
                ...
                <div class="form-group "><label class="col-md-4 control-label" for="protournoi_competitionbundle_competition_firstStepFormat">Format de la
                    ...
                    <div class="col-md-5">
                        <div class="input-group input-group-without-padding"><select id="protournoi_competitionbundle_competition_firstStepFormat" name="firstStepFormat" class="select-select2" style="width:100%" class="form-control">
                                <option value="">Sélectionnez un format de compétition</option>
                                <option value="Championnat">Championnat</option>
                                <option value="Championnat avec matchs aller et retour">Championnat avec matchs aller et retour</option>
                                <option value="Poules">Poules</option>
                                <option value="Poules avec matchs aller et retour">Poules avec matchs aller et retour</option>
                                <option value="Tableau à élimination directe">Tableau à élimination directe</option>
                                <option value="Tableau multi-chances">Tableau multi-chances</option>
        ...
        <input type="hidden" id="protournoi_competitionbundle_competition_flow_createCompetition_step" name="flow_createCompetition_step" class="form-control" value="1" /><input type="hidden" id="protournoi_competitionbundle_competition__token" name="_token" class="form-control" value="xEYf2y6-mcaeqn0-GUjNLbz1LcT0GDp9pR91WAtmLI8" />
